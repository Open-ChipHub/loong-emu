...
uint64_t helper_frecipe_s(CPULoongArchState*, uint64_t);
uint64_t helper_frecipe_d(CPULoongArchState*, uint64_t);
uint64_t helper_frsqrte_s(CPULoongArchState*, uint64_t);
uint64_t helper_frsqrte_d(CPULoongArchState*, uint64_t);
...
void helper_vfscaleb_s(void*, void*, void*, CPULoongArchState*, uint32_t);
void helper_vfscaleb_d(void*, void*, void*, CPULoongArchState*, uint32_t);
